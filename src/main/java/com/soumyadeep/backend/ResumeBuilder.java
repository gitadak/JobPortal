...
public class ResumeBuilder extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        try
        {
            ...
            // 3. Get PdfWriter instance without assigning it to a variable
            PdfWriter.getInstance(document, new FileOutputStream(PathDetails.RESUME_BUILDER_PATH + resume_pdf_name));
            // 4. Open document
            document.open();
