				...
				<div class="col-md-6 scroll-feature">
                    ...
                    try
                    {
                        ...
                        while(rs.next())
                        {
                            ...
                            <span class="fa fa-home"></span> <span style="color: #9f9d9d"> Company : </span> <span> <jsp:expression>company</jsp:expression> </span> <br>
                                ...
                                <br><a style="text-decoration: none" href="job-description.jsp?jid=<jsp:expression>id</jsp:expression>"> See Full Details </a>
                            </div>
